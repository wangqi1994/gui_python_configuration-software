...
class Ui_info(object):
    def setupUi(self, info):
        ...
        self.y.setGeometry(QtCore.QRect(68, 522, 16, 16))
        ...
        self.x.setGeometry(QtCore.QRect(68, 450, 16, 16))
        ...
        self.cameraip.setGeometry(QtCore.QRect(500, 390, 114, 16))
        self.cameraip.setObjectName("cameraip")
        self.camera_ip = QtWidgets.QLineEdit(self.centralwidget)
        self.camera_ip.setGeometry(QtCore.QRect(709, 390, 133, 20))
        ...
        self.duojizhuban.setGeometry(QtCore.QRect(499, 167, 121, 16))
        ...
        self.duojizhuban_port.setGeometry(QtCore.QRect(708, 167, 133, 20))
        ...
        self.autocharge_x.setGeometry(QtCore.QRect(277, 450, 133, 20))
        self.autocharge_x.setObjectName("autocharge_x")
        self.autocharge_xyz = QtWidgets.QLabel(self.centralwidget)
        self.autocharge_xyz.setGeometry(QtCore.QRect(68, 386, 132, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.fenbushi_port.setGeometry(QtCore.QRect(710, 95, 133, 20))
        ...
        self.app_ip.setGeometry(QtCore.QRect(500, 311, 150, 16))
        ...
        self.wddy.setGeometry(QtCore.QRect(499, 239, 78, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.autocharge_yaw.setGeometry(QtCore.QRect(277, 594, 133, 20))
        ...
        self.yaw.setGeometry(QtCore.QRect(68, 594, 18, 16))
        ...
        self.wddy_port.setGeometry(QtCore.QRect(708, 239, 133, 20))
        ...
        self.vec_line = QtWidgets.QLabel(self.centralwidget)
        self.vec_line.setGeometry(QtCore.QRect(500, 450, 114, 16))
        self.vec_line.setObjectName("vec_line")
        self.vec_rad = QtWidgets.QLabel(self.centralwidget)
        self.vec_rad.setGeometry(QtCore.QRect(500, 522, 114, 16))
        self.vec_rad.setObjectName("vec_rad")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(709, 450, 133, 20))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox_2 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_2.setGeometry(QtCore.QRect(709, 522, 133, 20))
        ...
        self.label.setGeometry(QtCore.QRect(500, 480, 131, 21))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.label_2.setGeometry(QtCore.QRect(500, 550, 131, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, info):
        ...
        self.vec_line.setText(_translate("info", "底盘直线速度"))
        self.vec_rad.setText(_translate("info", "底盘旋转速度"))
        self.comboBox.setItemText(0, _translate("info", "0.7"))
        self.comboBox.setItemText(1, _translate("info", "0.5"))
        self.comboBox.setItemText(2, _translate("info", "0.6"))
        self.comboBox_2.setItemText(0, _translate("info", "0.8"))
        self.comboBox_2.setItemText(1, _translate("info", "0.5"))
        self.comboBox_2.setItemText(2, _translate("info", "0.6"))
        self.comboBox_2.setItemText(3, _translate("info", "0.7"))
        self.label.setText(_translate("info", "关键参数，修改须谨慎"))
        self.label_2.setText(_translate("info", "关键参数，修改须谨慎"))
